...
;
	($.$invite_dict) = class $invite_dict extends ($.$mol_page) {
		word_label(next){
			if(next !== undefined) return next;
			return "";
		}
		...
		Word(){
			...
			(obj.content) = () => ([(this.Transcription())]);
			return obj;
		}
		word(next){
			if(next !== undefined) return next;
	...
	($mol_mem(($.$invite_dict.prototype), "word_label"));
	($mol_mem(($.$invite_dict.prototype), "transcription"));
	($mol_mem(($.$invite_dict.prototype), "Transcription"));
	($mol_mem(($.$invite_dict.prototype), "Word"));
	($mol_mem(($.$invite_dict.prototype), "word"));
	($mol_mem(($.$invite_dict.prototype), "Search"));
...
;
	($.$invite_app) = class $invite_app extends ($.$invite_dict) {};
